export default {
  ...
  search_sura_name: "Search sura name...",
  ...
  step_mode: "Display Mode",
  step_mode_desc: "Choose how Quran pages are displayed",
  mode_image: "Page Images",
  mode_image_desc: "Original high-quality images\nRequires internet or offline download",
  mode_text: "Digital Text",
  mode_text_desc: "Formatted Quran text\nWorks offline, no download needed",
  step_theme: "Theme & Font",
  step_theme_desc: "Pick a reading color and Quran font",
  choose_theme: "Choose Color",
  step_next: "Next",
  step_prev: "Back",
  ...
  delete_dhikr_confirm: "Delete this dhikr?",
  vibrate: "Vibration",
  from_quran: "From Quran",
  load_ayah: "Load Verse",
  dhikr_arabic: "Dhikr Text",
  // Text Mushaf
  text_mushaf: "Text Mushaf",
  image_mushaf: "Image Mushaf",
  mushaf_mode: "Reading Mode",
  text_font: "Mushaf Font",
  font_size: "Font Size",
  ...
  warsh_db_reciters: "Warsh Reciters",
  ...
  exit_prayer_reading: "Exit reading mode?",
  ...
  fahres: "Index",
  unit_rob3: "Quarter Hizb",
  unit_hizb: "Hizb",
  unit_juz: "Juz",
  choose_unit: "Daily Reading Unit",
  start_from_juz: "Start from Juz",
  khatma_summary: "You'll finish on",
  khatma_days_needed: "days",
  ...
  media_video: "Video",
  media_radio: "Radio",
  warsh_recitation: "Warsh recitation",
  suras_count: "suras",
  ...
  backup_export_desc: "Export settings and bookmarks as a JSON file",
