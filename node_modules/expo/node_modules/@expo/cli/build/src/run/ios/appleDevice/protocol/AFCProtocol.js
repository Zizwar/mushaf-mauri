    ...
    constructor(socket){
        ...
        const reader = this.readerFactory.create((resp, err)=>{
            if (err && err instanceof AFCInternalError) {
                var _this_requestCallbacks_err_requestId;
                (_this_requestCallbacks_err_requestId = this.requestCallbacks[err.requestId]) == null ? void 0 : _this_requestCallbacks_err_requestId.call(this.requestCallbacks, resp, err);
            } else if (isErrorStatusResponse(resp)) {
                var _this_requestCallbacks_resp_id;
                (_this_requestCallbacks_resp_id = this.requestCallbacks[resp.id]) == null ? void 0 : _this_requestCallbacks_resp_id.call(this.requestCallbacks, resp, new AFCError((AFC_STATUS == null ? void 0 : AFC_STATUS[resp.data]) ?? 'UNKNOWN_ERROR', resp.data));
            } else {
                var _this_requestCallbacks_resp_id1;
                (_this_requestCallbacks_resp_id1 = this.requestCallbacks[resp.id]) == null ? void 0 : _this_requestCallbacks_resp_id1.call(this.requestCallbacks, resp);
            }
        });
