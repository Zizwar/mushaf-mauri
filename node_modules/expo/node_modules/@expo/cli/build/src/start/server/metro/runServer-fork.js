            ...
            httpServer.on('upgrade', (request, socket, head)=>{
                ...
                if (pathname != null && websocketEndpoints[pathname]) {
                    websocketEndpoints[pathname].handleUpgrade(request, socket, head, (ws)=>{
                        var _websocketEndpoints_pathname;
                        (_websocketEndpoints_pathname = websocketEndpoints[pathname]) == null ? void 0 : _websocketEndpoints_pathname.emit('connection', ws, request);
                    });
                } else {
                    socket.destroy();
                }
