...
class WebSupportProjectPrerequisite extends _Prerequisite.ProjectPrerequisite {
    ...
    /** Exposed for testing. */ async _ensureWebDependenciesInstalledAsync({ exp, pkg }) {
        ...
        const hasReactNative = !!(((_pkg_dependencies = pkg.dependencies) == null ? void 0 : _pkg_dependencies['react-native']) || ((_pkg_devDependencies = pkg.devDependencies) == null ? void 0 : _pkg_devDependencies['react-native']));
        if (hasReactNative) {
        ...
        try {
            ...
            var _pkg_dependencies1, _pkg_devDependencies1;
            ...
            const hasReactDOM = !!(((_pkg_dependencies1 = pkg.dependencies) == null ? void 0 : _pkg_dependencies1['react-dom']) || ((_pkg_devDependencies1 = pkg.devDependencies) == null ? void 0 : _pkg_devDependencies1['react-dom']));
            if (hasReactDOM) {
