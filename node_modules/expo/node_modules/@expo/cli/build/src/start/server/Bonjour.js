...
class Bonjour {
    ...
    async announceAsync({ exp = (0, _config().getConfig)(this.projectRoot).exp, username = (_getSession = (0, _UserSettings.getSession)()) == null ? void 0 : _getSession.username }) {
        var _exp_name, _exp_slug, _exp_android_package, _exp_android, _exp_ios_bundleIdentifier, _exp_ios;
        ...
        this.stopAdvertising = dnssd.advertise({
            ...
            txt: {
                ...
                androidPackage: (_exp_android = exp.android) == null ? void 0 : (_exp_android_package = _exp_android.package) == null ? void 0 : _exp_android_package.slice(0, 255),
                iosBundleIdentifier: (_exp_ios = exp.ios) == null ? void 0 : (_exp_ios_bundleIdentifier = _exp_ios.bundleIdentifier) == null ? void 0 : _exp_ios_bundleIdentifier.slice(0, 255),
                username: username == null ? void 0 : username.slice(0, 255)
            }
        });
    }
    async closeAsync() {
