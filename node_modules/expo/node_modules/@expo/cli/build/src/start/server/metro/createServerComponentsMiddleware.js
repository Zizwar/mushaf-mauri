...
function createServerComponentsMiddleware(projectRoot, { rscPath, instanceMetroOptions, ssrLoadModule, ssrLoadModuleArtifacts, useClientRouter, createModuleId, routerOptions }) {
    ...
    async function exportServerActionsAsync({ platform, entryPoints, domRoot }, files) {
        ...
        async function processEntryPoint(entryPoint) {
            var _contents_artifacts_filter__metadata_reactClientReferences, _contents_artifacts_filter_, _contents_artifacts_filter__metadata_reactServerReferences, _contents_artifacts_filter_1;
            ...
            const reactClientReferences = (_contents_artifacts_filter_ = contents.artifacts.filter((a)=>a.type === 'js')[0]) == null ? void 0 : (_contents_artifacts_filter__metadata_reactClientReferences = _contents_artifacts_filter_.metadata.reactClientReferences) == null ? void 0 : _contents_artifacts_filter__metadata_reactClientReferences.map((ref)=>fileURLToFilePath(ref));
            if (reactClientReferences) {
                nestedClientBoundaries.push(...reactClientReferences);
            }
            const reactServerReferences = (_contents_artifacts_filter_1 = contents.artifacts.filter((a)=>a.type === 'js')[0]) == null ? void 0 : (_contents_artifacts_filter__metadata_reactServerReferences = _contents_artifacts_filter_1.metadata.reactServerReferences) == null ? void 0 : _contents_artifacts_filter__metadata_reactServerReferences.map((ref)=>fileURLToFilePath(ref));
    ...
    async function getExpoRouterClientReferencesAsync({ platform, domRoot }, files) {
        var _contents_artifacts_filter__metadata_reactServerReferences, _contents_artifacts_filter_, _contents_artifacts_filter__metadata_reactClientReferences, _contents_artifacts_filter_1;
        ...
        const reactServerReferences = (_contents_artifacts_filter_ = contents.artifacts.filter((a)=>a.type === 'js')[0]) == null ? void 0 : (_contents_artifacts_filter__metadata_reactServerReferences = _contents_artifacts_filter_.metadata.reactServerReferences) == null ? void 0 : _contents_artifacts_filter__metadata_reactServerReferences.map((ref)=>fileURLToFilePath(ref));
        if (!reactServerReferences) {
        ...
        const reactClientReferences = (_contents_artifacts_filter_1 = contents.artifacts.filter((a)=>a.type === 'js')[0]) == null ? void 0 : (_contents_artifacts_filter__metadata_reactClientReferences = _contents_artifacts_filter_1.metadata.reactClientReferences) == null ? void 0 : _contents_artifacts_filter__metadata_reactClientReferences.map((ref)=>fileURLToFilePath(ref));
        if (!reactClientReferences) {
