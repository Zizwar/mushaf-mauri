...
_export(exports, {
    get addInteractionListener () {
        return addInteractionListener;
    },
    get confirmAsync () {
        return confirmAsync;
    },
    get createSelectionFilter () {
        return createSelectionFilter;
    },
    get default () {
        return prompt;
    },
    get pauseInteractions () {
        return pauseInteractions;
    },
    get promptAsync () {
        return promptAsync;
    },
    get removeInteractionListener () {
        return removeInteractionListener;
    },
    get resumeInteractions () {
...
function _prompts() {
    const data = /*#__PURE__*/ _interop_require_default(require("prompts"));
    _prompts = function() {
        return data;
    };
    return data;
...
async function prompt(questions, { nonInteractiveHelp, ...options } = {}) {
    ...
    if (!(0, _interactive.isInteractive)() && questions.length) {
