 ...
 */
export declare function getAsset(relativePath: string, projectRoot: string, watchFolders: ReadonlyArray<string>, platform: null | undefined | string, assetExts: ReadonlyArray<string>, fileExistsInFileMap?: (absolutePath: string) => boolean): Promise<Buffer>;