...
export interface _ReadonlySourceLocation_start {
  readonly line: number;
  readonly column: number;
}
export interface _ReadonlySourceLocation_end {
  readonly line: number;
  readonly column: number;
}
export interface ReadonlySourceLocation {
  readonly start: _ReadonlySourceLocation_start;
  readonly end: _ReadonlySourceLocation_end;
}
export interface BundleOptions {
  ...
  onProgress?: null | ((doneCont: number, totalCount: number) => unknown);
