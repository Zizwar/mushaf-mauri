...
const _featureFlags = {
  experiment: {
    ...
    iosPreventReattachmentOfDismissedModals: RNS_IOS_PREVENT_REATTACHMENT_OF_DISMISSED_MODALS,
...
const iosPreventReattachmentOfDismissedModalsAccessor = createExperimentalFeatureFlagAccessor('iosPreventReattachmentOfDismissedModals', RNS_IOS_PREVENT_REATTACHMENT_OF_DISMISSED_MODALS);
...
export const featureFlags = {
  ...
  experiment: {
    ...
    set iosPreventReattachmentOfDismissedModals(value) {
