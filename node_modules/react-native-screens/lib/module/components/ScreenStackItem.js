...
import { TopInsetApplicationContext, useTopInsetApplication } from './contexts/TopInsetApplicationContext';
function ScreenStackItem({
  ...
  const headerTopInsetDisabled = headerConfig?.disableTopInsetApplication ?? false;
  const {
    nextContextValue
  } = useTopInsetApplication(headerVisible, headerTopInsetDisabled);
  ...
  warnOnce(hasEdgeEffects && hasBlurEffect && isIOS26OrHigher, '[RNScreens] Using both `blurEffect` and `scrollEdgeEffects` simultaneously may cause overlapping effects.');
  ...
  const content = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TopInsetApplicationContext.Provider, {
    value: nextContextValue
  }, /*#__PURE__*/React.createElement(DebugContainer, {
