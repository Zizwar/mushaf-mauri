...
import SplitHostNativeComponent, { Commands as SplitHostNativeCommands } from '../../../fabric/gamma/split/SplitHostNativeComponent';
...
function SplitHost({
  ...
  return /*#__PURE__*/React.createElement(SplitHostNativeComponent, _extends({
    ref: nativeRef
