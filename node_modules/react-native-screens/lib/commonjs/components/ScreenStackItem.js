...
var _TopInsetApplicationContext = require("./contexts/TopInsetApplicationContext");
...
function ScreenStackItem({
  ...
  const {
    nextContextValue
  } = (0, _TopInsetApplicationContext.useTopInsetApplication)(headerVisible, headerTopInsetDisabled);
  ...
  const content = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_TopInsetApplicationContext.TopInsetApplicationContext.Provider, {
