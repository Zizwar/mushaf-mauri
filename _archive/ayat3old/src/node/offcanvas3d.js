...
class OffCanvas3D extends Component {
  ...
  componentDidUpdate() {
    ...
    if (false/*this.props.handleBackPress && !this.props.active*/) {
  ...
  render() {
      ...
      return (
        <TouchableWithoutFeedback
          ...
          onPress={_ => {
            ...
            if (this.state.menuItems[index].onPress)
            this.state.menuItems[index].onPress()
            else
              this._handlePress(index);
    ...
    return (
      ...
      >
        ...
        source={ this.props.backgroundImg ?this.props.backgroundImg :null}
      />
