...
export const SET_DOWNLOAD_HAFS = "wino/set/SET_DOWNLOAD_HAFS";
export const SET_DOWNLOAD_HAFS_DORAR = "wino/set/SET_DOWNLOAD_HAFS_DORAR";
export const SET_DOWNLOAD_WARSH = "wino/set/SET_DOWNLOAD_WARSH";
export const SET_DOWNLOAD_TAJWEED = "wino/set/SET_DOWNLOAD_TAJWEED";
...
const initialState = {
	tmp:null,
	theme:{backgroundColor:"#fff",color:"#555"},
	tarajemDB:[],
  records:[],
  first:true,
  fontSize:14,
...
export default function reducer(state = initialState, action) {
  switch (action.type) {
    ...
    case SET_DOWNLOAD_HAFS:
      return {
        ...state,
        downloadsHafs: action.payload.data
      };
		  case SET_DOWNLOAD_HAFS_DORAR:
      return {
        ...state,
        downloadshafsDorar: action.payload.data
      };
      ...
      return {
        ...
        downloadsWarsh: action.payload.data
		  ...
		  case SET_DOWNLOAD_TAJWEED:
      return {
        ...state,
        downloadsTajweed: action.payload.data
      };
    case SET_OPTIONS:
      return {
        ...state,
